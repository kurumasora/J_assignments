...
int main() {
    ...
    fprintf(file, "\n=============================================\n");
    fprintf(file, "新しいゲーム開始: %s", ctime(&now));
    fprintf(file, "=============================================\n");
    ...
    if (player1.score > player2.score) {
        ...
        printf("プレイヤー1の勝利！\n");
        fprintf(file, "プレイヤー1の勝利\n");
    } else if (player2.score > player1.score) {
 
        printf("プレイヤー2の勝利！\n");
        fprintf(file, "プレイヤー2の勝利\n");
    } else {
 
        printf("引き分け！\n");
        fprintf(file, "引き分け\n");
    }
    printf("game_result.txtにゲームの結果を追記しました！\n");
